  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  TargetManager(RTC::Manager* manager);
 ...
 protected:
  ...
  /*!
   */
  RTC::CorbaConsumer<ogata::TidyUpManager> m_tidyUpManager;
...
extern "C"
{
  DLL_EXPORT void TargetManagerInit(RTC::Manager* manager);
};
